...
// 配置代理  Object.defineProperty实现  也就是说 访问vm.xxx 就会触发get 返回的是 vm._data.xxx
...
// initState---主要对 props methods data computed watcher 初始化操作
...
function initProps(vm: Component, propsOptions: Object) {
  ...
  for (const key in propsOptions) {
    ...
    // instantiation here.
    if (!(key in vm)) {
      // 通过代理，把vm.props.xxx 代理到vm.xxx 上
      proxy(vm, `_props`, key);
    }
  }
...
// 配置代理  vm._data.xxx = vm.xxx 把里面的数据变成响应式
